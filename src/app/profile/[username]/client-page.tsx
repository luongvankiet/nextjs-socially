...
function ClientPage({ isFollowing: initialIsFollowing, likedPosts, posts, user }: ClientPageProps) {
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col items-center text-center">
                ...
                {!currentUser ? (
                  ...
                  <Button className="mt-4 w-full" onClick={handleFollow} disabled={isUpdatingFollow} variant={isFollowing ? 'outline' : 'default'}>
